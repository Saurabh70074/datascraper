...
// Main function
(async function main() {
    const inputFilePath = 'users-user_links_one.csv'; // Replace with your input CSV file path
    const outputFilePath = 'output_with_selenium.csv'; // Replace with your desired output file path
