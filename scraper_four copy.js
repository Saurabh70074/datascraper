...
// Main function
(async function main() {
    const inputFilePath = 'users-user_links_four.csv'; // Replace with your input CSV file path
    const outputFilePath = 'output_with_selenium_four.csv'; // Replace with your desired output file path
